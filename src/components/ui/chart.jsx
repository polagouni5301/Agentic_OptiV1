      ...
      children: payload.filter(item => item.type !== "none").map((item, index) => {
        ...
        return /*#__PURE__*/_jsx("div", {
          ...
          children: formatter && item?.value !== undefined && item.name ? formatter(item.value, item.name, item, index, item.payload) : /*#__PURE__*/_jsxs(_Fragment, {
            children: [itemConfig?.icon ? /*#__PURE__*/_jsx(itemConfig.icon, {}) : !hideIndicator && /*#__PURE__*/_jsx("div", {
  ...
  return /*#__PURE__*/_jsx("div", {
    ...
    children: payload.filter(item => item.type !== "none").map(item => {
      ...
      return /*#__PURE__*/_jsxs("div", {
        ...
        children: [itemConfig?.icon && !hideIcon ? /*#__PURE__*/_jsx(itemConfig.icon, {}) : /*#__PURE__*/_jsx("div", {
