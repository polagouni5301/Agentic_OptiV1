...
const NavigationMenu = /*#__PURE__*/React.forwardRef(({
  ...
  children,
  ...props
}, ref) => /*#__PURE__*/_jsxs(NavigationMenuPrimitive.Root, {
  ref: ref,
  className: cn("relative z-10 flex max-w-max flex-1 items-center justify-center", className),
  ...props,
  children: [children, /*#__PURE__*/_jsx(NavigationMenuViewport, {})]
}));
NavigationMenu.displayName = NavigationMenuPrimitive.Root.displayName;
const NavigationMenuList = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(NavigationMenuPrimitive.List, {
  ref: ref,
...
const NavigationMenuTrigger = /*#__PURE__*/React.forwardRef(({
  ...
  children,
  ...props
}, ref) => /*#__PURE__*/_jsxs(NavigationMenuPrimitive.Trigger, {
  ref: ref,
...
const NavigationMenuContent = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(NavigationMenuPrimitive.Content, {
  ref: ref,
...
const NavigationMenuIndicator = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(NavigationMenuPrimitive.Indicator, {
  ref: ref,
