...
const SelectTrigger = /*#__PURE__*/React.forwardRef(({
  ...
  children,
  ...props
}, ref) => /*#__PURE__*/_jsxs(SelectPrimitive.Trigger, {
  ref: ref,
...
const SelectScrollUpButton = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SelectPrimitive.ScrollUpButton, {
  ref: ref,
...
const SelectScrollDownButton = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SelectPrimitive.ScrollDownButton, {
  ref: ref,
  className: cn("flex cursor-default items-center justify-center py-1", className),
  ...props,
  children: /*#__PURE__*/_jsx(ChevronDown, {
...
const SelectContent = /*#__PURE__*/React.forwardRef(({
  ...
  position = "popper",
  ...props
}, ref) => /*#__PURE__*/_jsx(SelectPrimitive.Portal, {
...
const SelectLabel = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SelectPrimitive.Label, {
  ref: ref,
...
const SelectItem = /*#__PURE__*/React.forwardRef(({
  ...
  children,
  ...props
}, ref) => /*#__PURE__*/_jsxs(SelectPrimitive.Item, {
  ref: ref,
...
const SelectSeparator = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SelectPrimitive.Separator, {
  ref: ref,
