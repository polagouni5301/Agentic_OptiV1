...
const SheetOverlay = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SheetPrimitive.Overlay, {
...
const SheetContent = /*#__PURE__*/React.forwardRef(({
  ...
  children,
  ...props
}, ref) => /*#__PURE__*/_jsxs(SheetPortal, {
  children: [/*#__PURE__*/_jsx(SheetOverlay, {}), /*#__PURE__*/_jsxs(SheetPrimitive.Content, {
    ref: ref,
    className: cn(sheetVariants({
      side
    }), className),
    ...props,
    children: [/*#__PURE__*/_jsxs(SheetPrimitive.Close, {
...
const SheetTitle = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SheetPrimitive.Title, {
  ref: ref,
...
const SheetDescription = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/_jsx(SheetPrimitive.Description, {
  ref: ref,
